...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      '1660super': envOrArray(process.env.DISCORD_NOTIFY_GROUP_1660SUPER),
      '1660ti': envOrArray(process.env.DISCORD_NOTIFY_GROUP_1660TI),
      ...
      lga1200: envOrArray(process.env.DISCORD_NOTIFY_GROUP_LGA1200),
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      lga1200: envOrNumber(process.env.MAX_PRICE_SERIES_LGA1200),
